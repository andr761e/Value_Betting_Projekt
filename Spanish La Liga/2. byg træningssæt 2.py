...
HomeWinProb = pd.read_excel("Spanish La Liga/Alle_kampe_med_elo_og_odds.xlsx", usecols="AV", skiprows=0, nrows=7981)
DrawProb = pd.read_excel("Spanish La Liga/Alle_kampe_med_elo_og_odds.xlsx", usecols="AW", skiprows=0, nrows=7981)
AwayWinProb = pd.read_excel("Spanish La Liga/Alle_kampe_med_elo_og_odds.xlsx", usecols="AX", skiprows=0, nrows=7981)
...
# 8) Gem til Excel
X_clean.to_excel("Spanish La Liga/X.xlsx", index=False)
y_aligned.to_excel("Spanish La Liga/Y.xlsx", index=False)
