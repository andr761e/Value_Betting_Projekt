...
cfg = LeagueSeasonConfig(
    ...
    elo_pickle="elo_dict_la_liga.pkl",
...
df_master  = pd.read_excel("Spanish La Liga/Alle_kampe_med_elo.xlsx")                 # korrekt rækkefølge
df_shuffle = pd.read_excel("Spanish La Liga/Odds_forkert_rækkefølge.xlsx")  # skal sorteres
...
BLOCK_SIZES = [380, 380, 380, 380, 380, 380, 380, 380, 380, 31]
...
sorted_odds_path = "Spanish La Liga/odds_kampe_sorteret.xlsx"
...
# Gem som før
master_out_path = "Spanish La Liga/Alle_kampe_med_elo_og_odds.xlsx"
