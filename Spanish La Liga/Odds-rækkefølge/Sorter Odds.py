...
df_shuffle = pd.read_excel("Spanish La Liga/Odds-rækkefølge/Odds_forkert_rækkefølge.xlsx")  # skal sorteres
...
sorted_odds_path = "Spanish La Liga/Odds-rækkefølge/odds_kampe_sorteret.xlsx"
