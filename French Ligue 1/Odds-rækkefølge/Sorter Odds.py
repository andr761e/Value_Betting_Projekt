...
df_shuffle = pd.read_excel("French Ligue 1/Odds-rækkefølge/Odds_forkert_rækkefølge.xlsx")  # skal sorteres
...
BLOCK_SIZES = [380, 380, 380, 279, 380, 380, 380, 306, 306, 27]
...
sorted_odds_path = "French Ligue 1/Odds-rækkefølge/odds_kampe_sorteret.xlsx"
