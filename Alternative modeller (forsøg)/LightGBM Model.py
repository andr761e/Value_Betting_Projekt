...
# Indlæs data
X = pd.read_excel("Alternative modeller (forsøg)/X.xlsx").to_numpy()
Y = pd.read_excel("Alternative modeller (forsøg)/Y.xlsx").to_numpy()
...
df_Xpred.to_excel("Alternative modeller (forsøg)/X_pred.xlsx", index=False)