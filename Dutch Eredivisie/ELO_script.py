...
add_team_elo(elo_dict, "ADO Den Haag", "DenHaag", 2018, 2025)
print(elo_dict["ADO Den Haag"])
add_team_elo(elo_dict, "AZ Alkmaar", "Alkmaar", 2018, 2025)
add_team_elo(elo_dict, "Ajax", "Ajax", 2018, 2025)
add_team_elo(elo_dict, "Almere City", "Almere", 2018, 2025)
add_team_elo(elo_dict, "Cambuur", "Cambuur", 2018, 2025)
add_team_elo(elo_dict, "De Graafschap", "DeGraafschap", 2018, 2025)
add_team_elo(elo_dict, "Den Bosch", "Bosch", 2018, 2025)
add_team_elo(elo_dict, "Dordrecht", "Dordrecht", 2018, 2025)
add_team_elo(elo_dict, "Emmen", "Emmen", 2018, 2025)
add_team_elo(elo_dict, "Excelsior", "Excelsior", 2018, 2025)
add_team_elo(elo_dict, "FC Eindhoven", "FC Eindhoven", 2018, 2025)
add_team_elo(elo_dict, "Feyenoord", "Feyenoord", 2018, 2025)
add_team_elo(elo_dict, "Fortuna Sittard", "Sittard", 2018, 2025)
add_team_elo(elo_dict, "Go Ahead Eagles", "Go Ahead Eagles", 2018, 2025)
add_team_elo(elo_dict, "Groningen", "Groningen", 2018, 2025)
add_team_elo(elo_dict, "Heerenveen", "Heerenveen", 2018, 2025)
add_team_elo(elo_dict, "Heracles Almelo", "Heracles", 2018, 2025)
add_team_elo(elo_dict, "MVV Maastricht", "Maastricht", 2018, 2025)
add_team_elo(elo_dict, "NAC Breda", "Breda", 2018, 2025)
add_team_elo(elo_dict, "NEC Nijmegen", "Nijmegen", 2018, 2025)
add_team_elo(elo_dict, "Oss", "Oss", 2018, 2025)
add_team_elo(elo_dict, "PSV Eindhoven", "PSV", 2018, 2025)
add_team_elo(elo_dict, "RKC Waalwijk", "Waalwijk", 2018, 2025)
add_team_elo(elo_dict, "Roda JC Kerkrade", "Kerkrade", 2018, 2025)
add_team_elo(elo_dict, "Sparta Rotterdam", "Sparta Rotterdam", 2018, 2025)
add_team_elo(elo_dict, "Telstar", "Telstar", 2018, 2025)
add_team_elo(elo_dict, "Twente", "Twente", 2018, 2025)
add_team_elo(elo_dict, "Utrecht", "Utrecht", 2018, 2025)
add_team_elo(elo_dict, "VVV-Venlo", "VVV-Venlo", 2018, 2025)
add_team_elo(elo_dict, "Vitesse", "Vitesse", 2018, 2025)
add_team_elo(elo_dict, "Volendam", "Volendam", 2018, 2025)
add_team_elo(elo_dict, "Willem II", "Willem", 2018, 2025)
add_team_elo(elo_dict, "Zwolle", "Zwolle", 2018, 2025)
...
# Gem én gang
save_elo_dict_pickle(elo_dict, "Dutch Eredivisie/elo_dict_eredivisie.pkl")

# …senere / i et nyt script:
elo_dict = load_elo_dict_pickle("Dutch Eredivisie/elo_dict_eredivisie.pkl")
