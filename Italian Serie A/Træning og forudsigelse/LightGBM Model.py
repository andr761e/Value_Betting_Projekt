...
# Indlæs data
X = pd.read_excel("Italian Serie A/X.xlsx").to_numpy()
Y = pd.read_excel("Italian Serie A/Y.xlsx").to_numpy()
...
# load elo_dict
with open("Italian Serie A/elo_dict_serie_a.pkl", "rb") as f:
...
df_Xpred.to_excel("Italian Serie A/Træning og forudsigelse/X_pred.xlsx", index=False)