...
cfg = LeagueSeasonConfig(
    ...
    elo_pickle="elo_dict_serie_a.pkl",
...
df_master  = pd.read_excel("Italian Serie A/Alle_kampe_med_elo.xlsx")                 # korrekt rækkefølge
df_shuffle = pd.read_excel("Italian Serie A/Odds_forkert_rækkefølge.xlsx")  # skal sorteres
...
sorted_odds_path = "Italian Serie A/odds_kampe_sorteret.xlsx"
...
# Gem som før
master_out_path = "Italian Serie A/Alle_kampe_med_elo_og_odds.xlsx"
