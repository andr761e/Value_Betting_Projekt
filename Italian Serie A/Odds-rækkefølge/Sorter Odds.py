...
df_shuffle = pd.read_excel("Italian Serie A/Odds-rækkefølge/Odds_forkert_rækkefølge.xlsx")  # skal sorteres
...
sorted_odds_path = "Italian Serie A/Odds-rækkefølge/odds_kampe_sorteret.xlsx"
