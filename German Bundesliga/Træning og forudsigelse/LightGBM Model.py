...
# Indlæs data
X = pd.read_excel("German Bundesliga/X.xlsx").to_numpy()
Y = pd.read_excel("German Bundesliga/Y.xlsx").to_numpy()
...
matches = pd.read_excel("German Bundesliga/Alle_kampe_med_elo.xlsx", usecols=columns_to_use)

# load elo_dict
with open("German Bundesliga/elo_dict_bundesliga.pkl", "rb") as f:
...
df_Xpred.to_excel("German Bundesliga/Træning og forudsigelse/X_pred.xlsx", index=False)