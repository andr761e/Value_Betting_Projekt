...
cfg = LeagueSeasonConfig(
    ...
    elo_pickle="elo_dict_bundesliga.pkl",
...
df_shuffle = pd.read_excel("German Bundesliga/Odds_forkert_rækkefølge.xlsx")  # skal sorteres
...
BLOCK_SIZES = [306, 306, 306, 306, 306, 305, 306, 306, 306, 18]
...
sorted_odds_path = "German Bundesliga/odds_kampe_sorteret.xlsx"
