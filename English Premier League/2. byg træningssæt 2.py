...
HomeWinProb = pd.read_excel("English Premier League/Alle_kampe_med_elo_og_odds.xlsx", usecols="AV", skiprows=0, nrows=7981)
DrawProb = pd.read_excel("English Premier League/Alle_kampe_med_elo_og_odds.xlsx", usecols="AW", skiprows=0, nrows=7981)
AwayWinProb = pd.read_excel("English Premier League/Alle_kampe_med_elo_og_odds.xlsx", usecols="AX", skiprows=0, nrows=7981)
