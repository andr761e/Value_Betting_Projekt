...
matches = pd.read_excel("English Premier League/Alle_kampe_med_elo.xlsx", usecols=columns_to_use)
...
fixtures = np.array([
    ["Arsenal", "Nottingham Forest", 1.42, 4.75, 7.00],
    ["Bournemouth", "Brighton & Hove Albion", 2.35, 3.6, 2.8],
    ["Crystal Palace","Sunderland",1.62, 3.8,5.5],
    ["Everton","Aston Villa",2.45,3.3,2.88],
    ["Fulham","Leeds United",1.91,3.4,4.1],
    ["Newcastle United","Wolverhampton Wanderers",1.48,4.33,6.5],
    ["West Ham United","Tottenham Hotspur",3.3,3.6,2.1],
    ["Nottingham Forest","West Ham United",1.66,3.75,5.25],
    ["Burnley","Liverpool",9.5,5.25,1.3],
    ["Manchester City", "Manchester United",1.7,3.9,4.75]
], dtype=object)
...
df_Xpred.to_excel("English Premier League/Træning og forudsigelse/X_pred.xlsx", index=False)