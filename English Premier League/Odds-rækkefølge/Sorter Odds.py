...
df_shuffle = pd.read_excel("English Premier League/Odds-rækkefølge/Odds_forkert_rækkefølge.xlsx")  # skal sorteres
...
sorted_odds_path = "English Premier League/Odds-rækkefølge/odds_kampe_sorteret.xlsx"
